...
def get_maxFscore_and_threshold_multi_beta(true_1d: np.ndarray, pred_1d: np.ndarray, beta: list=[0.3, 0.5, 1.0]) -> dict:
    """
    ...
    for _beta in beta:
        ...
        precision = precisions_cut[max_index]
        recall = recalls_cut[max_index]
        max_fscore = fbetas[max_index]
        corresponding_threshold = thres[max_index]
        result[_beta] = {"max_fscore": max_fscore, "threshold": corresponding_threshold, "precision": precision, "recall": recall}
